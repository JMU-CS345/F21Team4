/**
 * This class creates the Pixel object, which contain individual RGB values of a single pixel.
 * 
...
public class Pixel
{
  ...
  public int getChannel(int channel)
  {
    ...
    {
      throw new IllegalArgumentException("Channel must be between" + "0 - 2");
    }
   ...
   * 
   * @param other
   *          object to check if its equal to existing pixel
